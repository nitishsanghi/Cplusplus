...
ChatLogic::~ChatLogic()
{
    ...
    //std::cout << "ChatBot Destruction in Chatlogic" << std::endl;
    //delete _chatBot;

    // delete all nodes
    /*for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    {
        //std::cout << "deleteing nodes : " << std::to_string((**it).GetID())  << std::endl;
        //delete *it;
    }*/
    ...
    {
        //std::cout << "deleteing edges"  << std::endl;
        //delete *it;
    }*/
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    //std::cout << "Making local chabot" << std::endl;
    ChatBot chatBot("../images/chatbot.png");
    //std::cout << "Assigning handle" << std::endl;
    //SetChatbotHandle(&chatBot);
    chatBot.SetChatLogicHandle(this);
    //chatBot->SetRootNode(rootNode);
    //std::cout << "setting root node" << std::endl;
    chatBot.SetRootNode(rootNode);
    //std::cout << "Moving chat bot" << std::endl;
